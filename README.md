# sequenza-utils-rs / bam2seqz (v0.1.1)
...
This is the primary benchmark section for v0.1.1 release messaging.
...
Because of those correctness deltas, `samtools` remains the default backend in v0.1.1.
